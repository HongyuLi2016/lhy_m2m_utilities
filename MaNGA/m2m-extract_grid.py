...
from m2m_util_extract import extract
...
if __name__ == '__main__':
    ...
    for i in range(len(cfg_list)):
        ...
        try:
            ...
            lambda_value.append([lhy.lambda_value[obs]
                                 for obs in lhy.obs_list])
        except:
            chi2_total[i] = 20.0
    ...
    for i in range(len(lhy.obs_list)):
        ...
        np.save('{}/grid_rst/lambda_{}.npy'
                .format(gname, lhy.obs_list[i]), lambda_obs)
